export default
{
    ...
    appeallink: "discord.gg/uGzUxsbR2u",
    websocket: false,
    welcome: {
    ...
    //The default setting is the same as telling the fucking griefers to "take over", asshole!
    permission: {
        setOpLevel: 2,
        level_1: {
            tag: "uag:debugger",
        ...
        level_2: {
            tag: "uag:helper",
            password: "0OfR6QuVihUj8q?c"
        },
        level_3: {
            tag: "uag:moderator",
            password: "tr!bUM*zU$2akiPl34muqLgAwR89iwlt"
        },
        level_4: {
            tag: "uag:admin",
            password: "pujl12crlxi&ophl306lfrldr7mlxisAtowr$chewrisp$ch"
        },
        level_5: {
            tag: "uag:owner",
            password: "p-8wrekanufosTOT2adrufrimape0ramegapref1akisw9zls6osp11ucr+r2$ri"
        }
    },
    commands: {
        enabled: true,
        ...
        invsee: {
            enabled: true,
            permission: 2,
            aliases: [ "inventorysee", "inventoryview", "invview", "is", "iv" ]
        },
        vanish: {
            enabled: true,
            permission: 3,
    ...
    modules: {
        checktype: "slot", // "inventory" or "slot" or "none"
        whitelist: {
            users: [
                /**
            ...
            data: [
                {
                    ...
                    type: {
                        actionbar: false,
                        kill: false,
                        removePlaceBlock: true,
                        restoreBreakBlock: true,
                        killDropItem: true,
                        cancelItemUseOn: true,
                        cancelExplosion: true,
                        cancelPistonActivate: true,
                        farmland: true
                    },
                    whitelist: {
                        permission: 5,
        ...
        badenchants: {
            ...
            C: {
                ...
                allowItems: [
                    { id: "minecraft:apple", nameTag: "magic apple", enchant: "protection", level: 3 }
                ]
            },
            D: {
                enabled: true,
        ...
        grief: {
            ...
            D: {
                ...
                permission: {
                    survival: 0,
                    adventure: "fixation", // You cannot change the permission level here.
                    creative: 0,
                    spectator: 0
                }
            }
        ...
        morepackets: {
            ...
            2: {
                ...
                overRotationSpeed: 500,
                manyOverRotationSpeed: 60,
                manyOverRotationSpeedCount: 5
            },
            3: {
                enabled: true,
                punishment: {
